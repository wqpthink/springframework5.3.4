...
public interface EventListenerFactory {
	 ...
	 * @param method an {@link EventListener} annotated method  添加了EventListener注解的方法
	 * @return {@code true} if this factory supports the specified method  如果这个工厂支持指定的方法返回true
	 */
